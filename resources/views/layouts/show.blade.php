...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{'http://image.tmdb.org/t/p/w500'.$movie['poster_path']}}" alt="parasite" class="w-64 lg:w-96">
            <div class="md:ml-24"">
                <h2 class="text-4xl mt-4 md:mt-0 font-semibold">{{$movie['title']}}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    <a href="text-lg mt-2 hover:text-gray:300">{{$movie['title']}}</a>
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                @if ($loop->index < 5)
                    ...
                    <div class="mt-8">
                        <a href="#">
                        <img src="{{'http://image.tmdb.org/t/p/w300/'.$cast['profile_path']}}" alt="" srcset="" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
